...
type Interface interface {
	SubstribeToTopic(ctx context.Context, deviceToken, topic string) error
...
func (m *messaging) SubstribeToTopic(ctx context.Context, deviceToken, topic string) error {
